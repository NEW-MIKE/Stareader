...
import com.kaya.stareader.ui.adapter.AutoCompleteAdapter;
import com.kaya.stareader.ui.adapter.SearchHistoryAdapter;
import com.kaya.stareader.ui.base.BaseRVActivity;
import com.kaya.stareader.ui.contract.SearchContract;
import com.kaya.stareader.ui.easyadapter.SearchAdapter;
import com.kaya.stareader.ui.presenter.SearchPresenter;
...
public class SearchActivity extends BaseRVActivity<SearchDetail.SearchBooks> implements SearchContract.View {
    ...
    private void saveSearchHistory(String query) {
        List<String> list = ((StareaderApplication)getApplication()).getmAppPreferencesHelper().getSearchHistory();
        if (list == null) {
            list = new ArrayList<>();
            list.add(query);
        } else {
        ...
        ((StareaderApplication)getApplication()).getmAppPreferencesHelper().saveSearchHistory(list);
        initSearchHistory();
    }
    ...
    public void clearSearchHistory() {
        ((StareaderApplication)getApplication()).getmAppPreferencesHelper().saveSearchHistory(null);
        initSearchHistory();
    }
