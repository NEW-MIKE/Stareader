...
import com.kaya.stareader.ui.activity.BookDiscussionActivity;
import com.kaya.stareader.ui.activity.BookHelpActivity;
import com.kaya.stareader.ui.activity.BookReviewActivity;
import com.kaya.stareader.ui.activity.GirlBookDiscussionActivity;
...
public class CommunityFragment extends BaseFragment implements OnRvItemClickListener<FindBean> {
    ...
    public void initDatas() {
        ...
        mList.add(new FindBean("原创区",R.drawable.girl_section));
    }
